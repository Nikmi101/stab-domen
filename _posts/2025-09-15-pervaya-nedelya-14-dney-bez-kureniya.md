...
description: "Первые недели после отказа от курения: что вы почувствуете, где чаще всего случаются срывы и как мягко пройти этот отрезок без героизма и самокритики."
author:
  name: "Никита Митяев"
