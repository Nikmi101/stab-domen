---
title: "Бросил курить — тянет на сладкое: как не поменять сигареты на сахар"
description: "Почему после отказа от сигарет тянет на сладкое и как не набрать вес. Простая физиология, замещение никотина, культура питания и 30-дневный план без срывов."
author:
  name: "Никита Митяев"
...
tema: "Питание и тяга после отказа от курения"
categories: [privychki]
tags:
  - бросить курить и тянет на сладкое
...
faq:
  - q: "Почему после отказа от сигарет тянет на сладкое?"
    a: "Никотин притуплял аппетит и ускорял обмен. После отказа растёт чувствительность к голоду и ищется быстрый дофаминовый стимул — сладкое. Плюс привычные ритуалы требуют замены."
  - q: "Обязательно ли набирать вес после отказа от курения?"
    a: "Нет. Часть людей немного прибавляет в первые месяцы за счёт воды и аппетита, но при корректной структуре питания и активности вес стабилизируется."
  - q: "Чем заменить сладкое в острые моменты тяги?"
    a: "Тёплая вода/чай без сахара, газированная вода, греческий йогурт/творог, фрукты с орехами, горький шоколад 70–85% 1–2 дольки, жвачка без сахара."
  - q: "Как есть, чтобы не заедать синдром отмены?"
    a: "Регулярно: 3 приёма пищи + 1–2 перекуса, белок и клетчатка в каждом приёме, минимизировать «голодные ямы», пить воду, вводить «ритуалы вместо сахара»."
  - q: "Помогают ли диеты во время отказа от сигарет?"
    a: "Жёсткие диеты увеличивают вероятность срыва. Лучше мягкая структура питания и привычки, которые удерживают ритм без лишнего контроля."
banner:
  image: "/images/blog-images/blog-header.webp"
  alt: "бросил курить и тянет на сладкое"
  width: 1200
  height: 630
  title: "Бросил курить — тянет на сладкое: как не поменять сигареты на сахар"
recommended_apps:
