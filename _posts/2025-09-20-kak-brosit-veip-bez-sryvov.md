...
<!--
Для ориентиров по телесным изменениям см.: [«Что происходит с организмом после отказа от курения: по дням, неделям и месяцам»](/blog/privychki/chto-proishodit-posle-otkaza-kalendar/).
-->
...
- **Утро + кофе** → сенсорная пара «горькое + пар». Решение: менять посуду/напиток, **перестановка** на кухне.
  <!--
   **Утро + кофе** → сенсорная пара «горькое + пар». Решение: менять посуду/напиток, **перестановка** на кухне. См.: [«Кофе и „утренняя сигарета“: как пересобрать ритуал»](/blog/privychki/utrenniy-ritual-bez-sigarety/).
  -->
...
<!--
**Дни 8–14**: добавить 2–3 лёгкие тренировки, завести **дневник триггеров HALT** (голод, злость, одиночество, усталость) — см.: [«HALT: четыре стукача тяги»](/blog/privychki/halt-chetyre-triggera/).
-->
---
...
<!--
- **Не спать**: недосып = гипертяга. Связка со сном — в: [«Сон и отказ от никотина»](/blog/privychki/son-posle-otkaza/).
-->
---
...
-->
- При сложной зависимости от **нагреваемого табака (IQOS/GLO)**.
