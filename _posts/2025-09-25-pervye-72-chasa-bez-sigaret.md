...
description: "Подробный план на первые трое суток после отказа: что происходит в теле и психике, как пережить волны тяги по 90 секунд, какие замены работают, что не делать и когда обращаться за помощью."
author:
  name: "Никита Митяев"
...
- [Как работает синдром отмены: что ждёт после отказа](/blog/privychki/sindrom-otmeny/)
