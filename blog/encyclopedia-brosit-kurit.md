...
description: 'Полное руководство по отказу от сигарет: психология, тело, привычки, поддержка и восстановление. 70+ материалов, собранных в рамках проекта "Курил-бросил" от Vnutri Apps — чтобы бросить курить спокойно и навсегда.'
...
**Открытая энциклопедия от Vnutri Apps** — системный гид по жизни без сигарет:  
тело, эмоции, психология, поддержка и внутренние опоры.  

> 💡 Здесь собраны все статьи, созданные психологами и авторами приложения [**«Курил-бросил»**](/brosit-kurit) — без морали, без давления, с пониманием.
...
## 🔹 Раздел 2. Первые недели без сигарет: план, адаптация, симптомы
...
> Приложения Vnutri Apps — это практические инструменты, созданные на основе идей этой энциклопедии.  
> Они помогают не просто бросить курить, а выстраивать жизнь изнутри: спокойную и осознанную.
...
- 🪞 [**Одиночество: точки опоры**](/kak-borotsya-s-odinochestvom) — упражнения для внутренней связи и опоры.  
